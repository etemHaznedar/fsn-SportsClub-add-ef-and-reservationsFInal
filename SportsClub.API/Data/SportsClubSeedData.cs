...
public static class SportClubSeedData
{
    ...
    public static readonly List<Workout> Workouts
        = [atletiek, bodyAndMind, badminton, bootcamp, boulderen, boxFit, spikeball, sup, fitness, tennis, aerialSilk, duiken];
    ...
    public static readonly List<Lesson> Lessons
        =
    [
        new Lesson() {Id = lessonId++, WorkOutId = bootcamp.Id, Instructor = "Marcel", LocationId = wilderen.Id, StartDateTime = today.NextDayAt(DayOfWeek.Tuesday, 19, 30),CurrentCapacity = 21,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boxFit.Id, Instructor = "Coen", LocationId = dansStudio1.Id, StartDateTime = today.NextDayAt(DayOfWeek.Monday, 18, 0),CurrentCapacity = 4,MaxCapacity = 15},
        new Lesson() {Id = lessonId++, WorkOutId = spikeball.Id, Instructor = "Freek", LocationId = apenkooiGym.Id, StartDateTime = today.AtTime(18, 0),CurrentCapacity = 5,MaxCapacity = 16},
        new Lesson() {Id = lessonId++, WorkOutId = sup.Id, Instructor = "Miriam", LocationId = supAndFun.Id, StartDateTime = today.NextDayAt(DayOfWeek.Tuesday, 15, 0),CurrentCapacity = 21,MaxCapacity = 5},
        ...
        new Lesson() {Id = lessonId++, WorkOutId = acroYoga.Id, Instructor = "Marcel", LocationId = belcrumhuis.Id, StartDateTime = today.NextDayAt(DayOfWeek.Saturday, 10, 0),CurrentCapacity = 6,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = aerialSilk.Id, Instructor = "Laura", LocationId = paaldansStudio.Id, StartDateTime = today.NextDayAt(DayOfWeek.Friday, 19, 30),CurrentCapacity = 22,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = fitness.Id, Instructor = "Emilio", LocationId = fitnessRoom.Id, StartDateTime = today.NextDayAt(DayOfWeek.Sunday, 11, 0),CurrentCapacity = 22,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = tennis.Id, Instructor = "Judith", LocationId = tennisTVBN.Id, StartDateTime = today.AtTime(16, 0),CurrentCapacity = 12,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = aerialSilk.Id, Instructor = "Eva", LocationId = paaldansStudio.Id, StartDateTime = today.AtTime(19, 0),CurrentCapacity = 13,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = duiken.Id, Instructor = "Suzanne", LocationId = teteringseDijk.Id, StartDateTime = today.AtTime(20, 0),CurrentCapacity = 16,MaxCapacity = 17},
        new Lesson() {Id = lessonId++, WorkOutId = badminton.Id, Instructor = "zelf trainen", LocationId = bressSportcentrum.Id, StartDateTime = today.AtTime(17, 0),CurrentCapacity = 17,MaxCapacity = 17},
        new Lesson() {Id = lessonId++, WorkOutId = bodyAndMind.Id, Instructor = "Robert", LocationId = dansStudio1.Id, StartDateTime = today.AtTime(19, 30),CurrentCapacity = 21,MaxCapacity = 22},

        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Monday ,17, 0),CurrentCapacity = 5,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Tuesday ,17, 0),CurrentCapacity = 6,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Wednesday ,14, 0),CurrentCapacity = 5,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Thursday, 14, 0),CurrentCapacity = 4,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Friday, 14, 0),CurrentCapacity = 5,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Saturday, 10, 0),CurrentCapacity = 3,MaxCapacity = 22},
        new Lesson() {Id = lessonId++, WorkOutId = boulderen.Id, Instructor = "", LocationId = boulderhalBruut.Id, StartDateTime = today.NextDayAt(DayOfWeek.Sunday, 10, 0),CurrentCapacity = 5,MaxCapacity = 22},
    ];
